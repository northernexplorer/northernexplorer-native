export const m20260904: string[] = [
	`create table "image" ("id" uuid not null, "version" int not null default 1, "url" text not null, "filename" varchar(255) not null, "mime_type" varchar(255) not null, "size" int not null, "likes" int not null, "alt_text" text null, "processed" boolean not null default false, "point_of_interest_id" uuid not null, "user_id" uuid not null, "created_at" timestamptz not null, primary key ("id"));`,
