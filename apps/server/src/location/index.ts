...
export {PointOfInterestFavorite} from './entities/PointofInterestFavorite';
...
export {PointOfInterestFavoriteRepository} from './repositories/PointOfInterestFavoriteRepository';
