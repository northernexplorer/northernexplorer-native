...
export const config = {
	...
	EXPO_PUBLIC_REVENUE_CAT_GOOGLE_KEY: process.env.EXPO_PUBLIC_REVENUE_CAT_GOOGLE_KEY || 'goog_wbEWAJKThumlQYKsqvyOlyGVVnB',
	EXPO_PUBLIC_ARCGIS_API_KEY: process.env.EXPO_PUBLIC_ARCGIS_API_KEY,
	EXPO_CONTENT_DELIVERY_NETWORK: process.env.EXPO_CONTENT_DELIVERY_NETWORK,
};
